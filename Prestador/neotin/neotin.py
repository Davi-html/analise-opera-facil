...
def analisar_neotin():
    ...
    if dados_consolidados:
        ...
        df_consolidado.to_excel("Prestador/neotin/resultado/relatorio-neotin.xlsx", index=False)
        print("✓ Arquivo consolidado criado: relatorio-neotin.xlsx")
    ...
    if nao_listados_consolidados:
        ...
        df_nao_listados.to_excel("Prestador/neotin/resultado/CONSOLIDADO_NAO_LISTADOS.xlsx", index=False)
