...
def analisar_Segvision():
    arquivo = "relatorios_simplificados/separarSegvision_SIMPLIFICADO.xlsx"
    ...
    os.makedirs("Prestador/Segvision/resultado", exist_ok=True)
    ...
    if dados_consolidados:
        ...
        caminho_apenas_valores = "Prestador/Segvision/resultado/relatorio_Segvision_APENAS_VALORES.xlsx"
        ...
        caminho_completo = "Prestador/Segvision/resultado/relatorio_Segvision_COMPLETO.xlsx"
    ...
    if nao_listados_consolidados:
        ...
        caminho_nao_listados = "Prestador/Segvision/resultado/CONSOLIDADO_NAO_LISTADOS.xlsx"
