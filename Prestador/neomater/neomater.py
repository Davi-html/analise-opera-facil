...
def analisar_neomater():
    ...
    if dados_consolidados:
        ...
        df_consolidado.to_excel("Prestador/neomater/resultado/relatorio-neomater.xlsx", index=False)
        print("✓ Arquivo consolidado criado: relatorio-neomater.xlsx")
    ...
    if nao_listados_consolidados:
        ...
        df_nao_listados.to_excel("Prestador/neomater/resultado/CONSOLIDADO_NAO_LISTADOS.xlsx", index=False)
